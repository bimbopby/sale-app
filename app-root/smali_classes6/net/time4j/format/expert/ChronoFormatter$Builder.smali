...
.method private checkAfterDecimalDigits(Lnet/time4j/engine/ChronoElement;)Lnet/time4j/format/expert/FormatStep;
    ...
    const-string v1, " can\'t be inserted after an element"

    invoke-virtual {p1, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p1

    const-string v1, " with decimal digits."
...
.method public build(Lnet/time4j/format/Attributes;)Lnet/time4j/format/expert/ChronoFormatter;
    ...
    .line 6661
    iget-object v7, p0, Lnet/time4j/format/expert/ChronoFormatter$Builder;->steps:Ljava/util/List;

    invoke-interface {v7, v6}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object v7

    check-cast v7, Lnet/time4j/format/expert/FormatStep;

    invoke-virtual {v7}, Lnet/time4j/format/expert/FormatStep;->getSection()I
    ...
    .line 6682
    :cond_6
    new-instance v10, Lnet/time4j/format/expert/ChronoFormatter;

    iget-object v1, p0, Lnet/time4j/format/expert/ChronoFormatter$Builder;->chronology:Lnet/time4j/engine/Chronology;

    iget-object v2, p0, Lnet/time4j/format/expert/ChronoFormatter$Builder;->override:Lnet/time4j/engine/Chronology;

    iget-object v3, p0, Lnet/time4j/format/expert/ChronoFormatter$Builder;->locale:Ljava/util/Locale;

    iget-object v4, p0, Lnet/time4j/format/expert/ChronoFormatter$Builder;->steps:Ljava/util/List;

    iget-object v5, p0, Lnet/time4j/format/expert/ChronoFormatter$Builder;->defaultMap:Ljava/util/Map;

    iget-object v7, p0, Lnet/time4j/format/expert/ChronoFormatter$Builder;->deepestParser:Lnet/time4j/engine/Chronology;
    ...
    invoke-direct/range {v0 .. v8}, Lnet/time4j/format/expert/ChronoFormatter;-><init>(Lnet/time4j/engine/Chronology;Lnet/time4j/engine/Chronology;Ljava/util/Locale;Ljava/util/List;Ljava/util/Map;Lnet/time4j/format/Attributes;Lnet/time4j/engine/Chronology;Lnet/time4j/format/expert/ChronoFormatter$1;)V

    .line 6693
    iget-object v0, p0, Lnet/time4j/format/expert/ChronoFormatter$Builder;->pattern:Ljava/lang/String;
    ...
    .line 6696
    :cond_8
    invoke-static {v10}, Lnet/time4j/format/expert/ChronoFormatter;->access$700(Lnet/time4j/format/expert/ChronoFormatter;)Lnet/time4j/format/expert/AttributeSet;
    ...
    .line 6698
    sget-object v2, Lnet/time4j/format/Attributes;->FORMAT_PATTERN:Lnet/time4j/engine/AttributeKey;

    invoke-virtual {v1, v2, v0}, Lnet/time4j/format/expert/AttributeSet;->withInternal(Lnet/time4j/engine/AttributeKey;Ljava/lang/Object;)Lnet/time4j/format/expert/AttributeSet;
    ...
    .line 6701
    sget-object v2, Lnet/time4j/format/expert/ChronoFormatter$Builder;->CUSTOM_DAY_PERIOD:Lnet/time4j/engine/AttributeKey;
    ...
    invoke-direct {v0, v10, v1, v9}, Lnet/time4j/format/expert/ChronoFormatter;-><init>(Lnet/time4j/format/expert/ChronoFormatter;Lnet/time4j/format/expert/AttributeSet;Lnet/time4j/format/expert/ChronoFormatter$1;)V
