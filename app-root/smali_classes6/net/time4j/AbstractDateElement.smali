.class abstract Lnet/time4j/AbstractDateElement;
.super Lnet/time4j/format/DisplayElement;
.source "AbstractDateElement.java"
...
.method constructor <init>(Ljava/lang/String;)V
    ...
    .line 50
    new-instance p1, Lnet/time4j/DateOperator;

    const/4 v0, 0x0

    invoke-direct {p1, p0, v0}, Lnet/time4j/DateOperator;-><init>(Lnet/time4j/engine/ChronoElement;I)V

    iput-object p1, p0, Lnet/time4j/AbstractDateElement;->minimizer:Lnet/time4j/ElementOperator;
    ...
    iput-object p1, p0, Lnet/time4j/AbstractDateElement;->maximizer:Lnet/time4j/ElementOperator;
...
.method public atCeiling()Lnet/time4j/ElementOperator;
    ...
    .line 102
    new-instance v0, Lnet/time4j/DateOperator;

    const/4 v1, 0x5

    invoke-direct {v0, p0, v1}, Lnet/time4j/DateOperator;-><init>(Lnet/time4j/engine/ChronoElement;I)V
...
.method public atUTC()Lnet/time4j/engine/ChronoFunction;
    ...
    invoke-virtual {p0, v0}, Lnet/time4j/AbstractDateElement;->at(Lnet/time4j/tz/ZonalOffset;)Lnet/time4j/engine/ChronoFunction;
...
.method public inStdTimezone()Lnet/time4j/engine/ChronoFunction;
    ...
    invoke-virtual {p0, v0}, Lnet/time4j/AbstractDateElement;->in(Lnet/time4j/tz/Timezone;)Lnet/time4j/engine/ChronoFunction;
...
.method public inTimezone(Lnet/time4j/tz/TZID;)Lnet/time4j/engine/ChronoFunction;
    ...
    invoke-virtual {p0, p1}, Lnet/time4j/AbstractDateElement;->in(Lnet/time4j/tz/Timezone;)Lnet/time4j/engine/ChronoFunction;
...
.method public maximized()Lnet/time4j/ElementOperator;
    ...
    .line 74
    iget-object v0, p0, Lnet/time4j/AbstractDateElement;->maximizer:Lnet/time4j/ElementOperator;
...
.method public minimized()Lnet/time4j/ElementOperator;
    ...
    .line 67
    iget-object v0, p0, Lnet/time4j/AbstractDateElement;->minimizer:Lnet/time4j/ElementOperator;
...
.method public newValue(Ljava/lang/Comparable;)Lnet/time4j/ElementOperator;
    ...
    invoke-direct {v0, p0, v1, p1}, Lnet/time4j/DateOperator;-><init>(Lnet/time4j/engine/ChronoElement;ILjava/lang/Object;)V
...
.method public bridge synthetic newValue(Ljava/lang/Object;)Lnet/time4j/ElementOperator;
    ...
    invoke-virtual {p0, p1}, Lnet/time4j/AbstractDateElement;->newValue(Ljava/lang/Comparable;)Lnet/time4j/ElementOperator;
