.class abstract Lus/google/protobuf/CodedOutputStream$AbstractBufferedEncoder;
...
.method constructor <init>(I)V
    ...
    iput-object v0, p0, Lus/google/protobuf/CodedOutputStream$AbstractBufferedEncoder;->buffer:[B

    .line 10
    iput p1, p0, Lus/google/protobuf/CodedOutputStream$AbstractBufferedEncoder;->limit:I
...
.method final bufferInt32NoTag(I)V
    ...
    .line 4
    invoke-virtual {p0, v0, v1}, Lus/google/protobuf/CodedOutputStream$AbstractBufferedEncoder;->bufferUInt64NoTag(J)V
...
.method final bufferUInt32NoTag(I)V
    ...
    iput v4, p0, Lus/google/protobuf/CodedOutputStream$AbstractBufferedEncoder;->position:I

    int-to-long v3, v3

    int-to-byte p1, p1

    invoke-static {v2, v3, v4, p1}, Lus/google/protobuf/UnsafeUtil;->putByte([BJB)V
    ...
    invoke-static {v2, v3, v4, v5}, Lus/google/protobuf/UnsafeUtil;->putByte([BJB)V
...
.method final bufferUInt64NoTag(J)V
    ...
    .line 13
    iget p2, p0, Lus/google/protobuf/CodedOutputStream$AbstractBufferedEncoder;->totalBytesWritten:I

    add-int/2addr p2, p1

    iput p2, p0, Lus/google/protobuf/CodedOutputStream$AbstractBufferedEncoder;->totalBytesWritten:I
    ...
    iget v8, p0, Lus/google/protobuf/CodedOutputStream$AbstractBufferedEncoder;->position:I

    add-int/lit8 v9, v8, 0x1

    iput v9, p0, Lus/google/protobuf/CodedOutputStream$AbstractBufferedEncoder;->position:I
    ...
    invoke-static {v0, v8, v9, v10}, Lus/google/protobuf/UnsafeUtil;->putByte([BJB)V
    ...
    iget v6, p0, Lus/google/protobuf/CodedOutputStream$AbstractBufferedEncoder;->position:I

    add-int/lit8 v7, v6, 0x1

    iput v7, p0, Lus/google/protobuf/CodedOutputStream$AbstractBufferedEncoder;->position:I
