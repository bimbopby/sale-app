.class final Lus/google/protobuf/ByteBufferWriter;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lus/google/protobuf/ByteBufferWriter;->BUFFER:Ljava/lang/ThreadLocal;

    const-string v0, "java.io.FileOutputStream"

    .line 5
    invoke-static {v0}, Lus/google/protobuf/ByteBufferWriter;->safeGetClass(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v0

    sput-object v0, Lus/google/protobuf/ByteBufferWriter;->FILE_OUTPUT_STREAM_CLASS:Ljava/lang/Class;

    .line 7
    invoke-static {v0}, Lus/google/protobuf/ByteBufferWriter;->getChannelFieldOffset(Ljava/lang/Class;)J

    move-result-wide v0

    sput-wide v0, Lus/google/protobuf/ByteBufferWriter;->CHANNEL_FIELD_OFFSET:J
...
.method static clearCachedBuffer()V
    ...
    .line 1
    sget-object v0, Lus/google/protobuf/ByteBufferWriter;->BUFFER:Ljava/lang/ThreadLocal;
...
.method private static getChannelFieldOffset(Ljava/lang/Class;)J
    ...
    .line 3
    invoke-static {p0}, Lus/google/protobuf/UnsafeUtil;->objectFieldOffset(Ljava/lang/reflect/Field;)J
...
.method private static getOrCreateBuffer(I)[B
    ...
    .line 3
    invoke-static {}, Lus/google/protobuf/ByteBufferWriter;->getBuffer()[B
    ...
    invoke-static {p0, v1}, Lus/google/protobuf/ByteBufferWriter;->needToReallocate(II)Z
    ...
    .line 10
    invoke-static {v0}, Lus/google/protobuf/ByteBufferWriter;->setBuffer([B)V
...
.method static write(Ljava/nio/ByteBuffer;Ljava/io/OutputStream;)V
    ...
    .line 7
    :cond_0
    invoke-static {p0, p1}, Lus/google/protobuf/ByteBufferWriter;->writeToChannel(Ljava/nio/ByteBuffer;Ljava/io/OutputStream;)Z
    ...
    invoke-static {v1}, Lus/google/protobuf/ByteBufferWriter;->getOrCreateBuffer(I)[B
...
.method private static writeToChannel(Ljava/nio/ByteBuffer;Ljava/io/OutputStream;)Z
    ...
    .line 1
    sget-wide v0, Lus/google/protobuf/ByteBufferWriter;->CHANNEL_FIELD_OFFSET:J
    ...
    sget-object v2, Lus/google/protobuf/ByteBufferWriter;->FILE_OUTPUT_STREAM_CLASS:Ljava/lang/Class;
