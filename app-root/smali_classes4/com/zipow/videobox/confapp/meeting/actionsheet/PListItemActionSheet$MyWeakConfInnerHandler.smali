.class Lcom/zipow/videobox/confapp/meeting/actionsheet/PListItemActionSheet$MyWeakConfInnerHandler;
...
# static fields
.field private static final TAG:Ljava/lang/String; = "MyWeakConfInnerHandler in ZMUserDialogFragment"
...
.method public handleInnerMsg(Lus/zoom/proguard/up1;)Z
    ...
    const-string v3, "MyWeakConfInnerHandler in ZMUserDialogFragment"
    ...
    .line 11
    sget-object v3, Lcom/zipow/videobox/conference/model/message/ZmConfInnerMsgType;->PROMOTE_OR_DOWNGRADE:Lcom/zipow/videobox/conference/model/message/ZmConfInnerMsgType;
    ...
    invoke-static {v0, v2, v3}, Lcom/zipow/videobox/confapp/meeting/actionsheet/PListItemActionSheet;->access$700(Lcom/zipow/videobox/confapp/meeting/actionsheet/PListItemActionSheet;J)Z
