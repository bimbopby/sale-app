.class public Lus/zoom/proguard/on2;
.super Lus/zoom/proguard/k31;
.source "ZmScrollRecordActionSheet.java"


# static fields
.field private static final G:Ljava/lang/String; = "ZmScrollMoreActionSheet"
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lus/zoom/proguard/on2;->E:Lus/zoom/proguard/yw0;
    ...
    iput-object v0, p0, Lus/zoom/proguard/on2;->F:Lus/zoom/proguard/zw0;
...
.method public static b(Landroidx/fragment/app/FragmentManager;)V
    ...
    .line 2
    new-instance v1, Lus/zoom/proguard/on2;

    invoke-direct {v1}, Lus/zoom/proguard/on2;-><init>()V
...
.method private o()V
    ...
    new-instance v2, Lus/zoom/proguard/on2$h;

    invoke-direct {v2, p0}, Lus/zoom/proguard/on2$h;-><init>(Lus/zoom/proguard/on2;)V

    invoke-virtual {v0, v1, v2}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 12
    iget-object v1, p0, Lus/zoom/proguard/on2;->F:Lus/zoom/proguard/zw0;
...
.method private p()V
    ...
    .line 3
    new-instance v1, Lus/zoom/proguard/on2$l;

    invoke-direct {v1, p0}, Lus/zoom/proguard/on2$l;-><init>(Lus/zoom/proguard/on2;)V
    ...
    .line 13
    new-instance v1, Lus/zoom/proguard/on2$m;

    invoke-direct {v1, p0}, Lus/zoom/proguard/on2$m;-><init>(Lus/zoom/proguard/on2;)V
    ...
    .line 26
    new-instance v1, Lus/zoom/proguard/on2$n;

    invoke-direct {v1, p0}, Lus/zoom/proguard/on2$n;-><init>(Lus/zoom/proguard/on2;)V
    ...
    .line 35
    new-instance v1, Lus/zoom/proguard/on2$o;

    invoke-direct {v1, p0}, Lus/zoom/proguard/on2$o;-><init>(Lus/zoom/proguard/on2;)V
    ...
    .line 44
    iget-object v1, p0, Lus/zoom/proguard/on2;->E:Lus/zoom/proguard/yw0;
...
.method private q()V
    ...
    new-instance v2, Lus/zoom/proguard/on2$i;

    invoke-direct {v2, p0}, Lus/zoom/proguard/on2$i;-><init>(Lus/zoom/proguard/on2;)V
    ...
    new-instance v2, Lus/zoom/proguard/on2$j;

    invoke-direct {v2, p0}, Lus/zoom/proguard/on2$j;-><init>(Lus/zoom/proguard/on2;)V
    ...
    new-instance v2, Lus/zoom/proguard/on2$k;

    invoke-direct {v2, p0}, Lus/zoom/proguard/on2$k;-><init>(Lus/zoom/proguard/on2;)V
...
.method private r()V
    ...
    new-instance v2, Lus/zoom/proguard/on2$p;

    invoke-direct {v2, p0}, Lus/zoom/proguard/on2$p;-><init>(Lus/zoom/proguard/on2;)V
    ...
    new-instance v2, Lus/zoom/proguard/on2$a;

    invoke-direct {v2, p0}, Lus/zoom/proguard/on2$a;-><init>(Lus/zoom/proguard/on2;)V
...
.method private s()V
    ...
    .line 2
    new-instance v1, Lus/zoom/proguard/on2$b;

    invoke-direct {v1, p0}, Lus/zoom/proguard/on2$b;-><init>(Lus/zoom/proguard/on2;)V
    ...
    .line 12
    new-instance v1, Lus/zoom/proguard/on2$c;

    invoke-direct {v1, p0}, Lus/zoom/proguard/on2$c;-><init>(Lus/zoom/proguard/on2;)V
    ...
    .line 22
    new-instance v1, Lus/zoom/proguard/on2$d;

    invoke-direct {v1, p0}, Lus/zoom/proguard/on2$d;-><init>(Lus/zoom/proguard/on2;)V
    ...
    .line 33
    new-instance v1, Lus/zoom/proguard/on2$e;

    invoke-direct {v1, p0}, Lus/zoom/proguard/on2$e;-><init>(Lus/zoom/proguard/on2;)V
    ...
    .line 43
    new-instance v1, Lus/zoom/proguard/on2$f;

    invoke-direct {v1, p0}, Lus/zoom/proguard/on2$f;-><init>(Lus/zoom/proguard/on2;)V
    ...
    .line 53
    new-instance v1, Lus/zoom/proguard/on2$g;

    invoke-direct {v1, p0}, Lus/zoom/proguard/on2$g;-><init>(Lus/zoom/proguard/on2;)V
...
.method public onDestroyView()V
    ...
    .line 1
    iget-object v0, p0, Lus/zoom/proguard/on2;->E:Lus/zoom/proguard/yw0;

    invoke-virtual {v0}, Lus/zoom/proguard/yw0;->b()V

    .line 2
    iget-object v0, p0, Lus/zoom/proguard/on2;->F:Lus/zoom/proguard/zw0;
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    .line 2
    invoke-direct {p0}, Lus/zoom/proguard/on2;->p()V

    .line 3
    invoke-direct {p0}, Lus/zoom/proguard/on2;->q()V

    .line 4
    invoke-direct {p0}, Lus/zoom/proguard/on2;->r()V

    .line 5
    invoke-direct {p0}, Lus/zoom/proguard/on2;->s()V

    .line 6
    invoke-direct {p0}, Lus/zoom/proguard/on2;->o()V
