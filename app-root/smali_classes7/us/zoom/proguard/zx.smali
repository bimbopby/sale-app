.class public Lus/zoom/proguard/zx;
.super Lus/zoom/proguard/ay;
.source "MMSearchSelectSessionDialogFragment.java"
...
.method public constructor <init>()V
    ...
    .line 1
    invoke-direct {p0}, Lus/zoom/proguard/ay;-><init>()V

    return-void
.end method

.method public static a(Landroidx/fragment/app/Fragment;Landroid/os/Bundle;ZZZILjava/lang/String;IILjava/lang/String;)V
    .locals 5
    ...
    .line 3
    new-instance v2, Lus/zoom/proguard/zx;

    invoke-direct {v2}, Lus/zoom/proguard/zx;-><init>()V
    ...
    const-string p1, "searchSelectedUiMode"

    .line 11
    invoke-virtual {v3, p1, p5}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V

    const-string p1, "searchSelectedSessionId"

    .line 12
    invoke-virtual {v3, p1, p6}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    const-string p1, "searchSourceType"

    .line 13
    invoke-virtual {v3, p1, p7}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V

    const-string p1, "route_request_code"

    .line 14
    invoke-virtual {v3, p1, p8}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V

    const-string p1, "route_target_classname"

    .line 15
    invoke-virtual {v3, p1, p9}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    .line 7
    new-instance v0, Lus/zoom/proguard/zx$a;

    invoke-direct {v0, p0, p2}, Lus/zoom/proguard/zx$a;-><init>(Lus/zoom/proguard/zx;Landroid/app/Dialog;)V
